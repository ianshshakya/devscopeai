...
const ROLES = [
  { value: 'Frontend Developer', icon: <Code2 size={16} />, color: 'var(--text-primary)' },
              ...
              {SKILL_LEVELS.map((level) => (
                <button
                  ...
                  style={{
                    ...
                    background: skillLevel === level.value ? 'var(--border)' : 'rgba(15,23,36,0.5)',
              ...
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: 16 }}>
                {ideas.map((idea, i) => (
                  ...
                  >
                    ...
                    {/* Why it matters */}
                    <div style={{ padding: '8px 12px', borderRadius: 8, background: 'var(--border)', border: '1px solid var(--border)', marginBottom: 12 }}>
